...
RUN R -e "install.packages(c('neuralnet'), repos='http://cran.cc.uoc.gr/mirrors/CRAN/')"
COPY GenericR_1.1.5.tar.gz /packages/
USER root

RUN R CMD INSTALL /packages/GenericR_1.1.5.tar.gz --library=/usr/local/lib/R/site-library
